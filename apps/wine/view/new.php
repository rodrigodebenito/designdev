...
<body>
  ...
  <div id="page">
    ...
    <div id="main">
        ...
        <tr>
          <td class="label">
            <label>Article Timestamp (for email link)</label>
          </td>
          <td><input type="text" id="wlarticledate" onblur="if(this.value=='') { this.value='Month Day, Year'; }" onfocus="if(this.value=='Month Day, Year') { this.value=''; }"  value="<? if($saved) { echo $saved['articledate']; } else { echo "Month Day, Year"; } ?>"  name="wl[articledate]" class="short"></td>
        </tr>
...
<? for ($i=1; $i <= 10; $i++) { ?>
		<table class="subForm">
          ...
          <tr>
			...
			<td>
				<label>Producer <!-- Short Name--></label> <input type="text" value="<? if($saved) { echo $saved['shortname'.$i]; } ?>" class="short"  name="wl[shortname<? echo $i; ?>]"> &nbsp; &nbsp; 
				...
				<label>Label Information <!-- Full Name --></label> <input type="text" value="<? if($saved) { echo $saved['fullname'.$i]; } ?>"  name="wl[fullname<? echo $i; ?>]"><br>
...
<? } ?>		
          ...
          <div><br>
            <input type="submit" value="Save / Generate HTML" onclick="if (document.getElementById('wlSlug').value=='' || (document.getElementById('wlarticleurl').value=='' || document.getElementById('wlarticleurl').value=='http://'))
            { alert('The article slug & URL are required. The slug is used to save the wine list.'); return false; }">
          </div>
        </form>
        <br><br>
