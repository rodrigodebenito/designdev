          ...
          <tr>
			...
			<td>
				...
				<select name="wl[rating<? echo $i; ?>]" size="1">
					...
					<option value="**** 1/2"<? if($saved['rating'.$i]=="**** 1/2") { echo ' selected="selected"'; } ?>>**** 1/2</option>
					<option value="****"<? if($saved['rating'.$i]=="****") { echo ' selected="selected"'; } ?>>****</option>
...
<? } ?>		
          ...
          <div><br>
            <input type="submit" value="Save / Generate HTML" onclick="if(document.getElementById('wlSlug').value=='') { alert('The article slug is required. This is used to save the wine list.'); return false; }">
          </div>
        </form>
        <br><br>
