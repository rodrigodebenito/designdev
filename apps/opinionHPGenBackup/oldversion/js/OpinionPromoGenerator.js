...
ElementSundayReview = (function(_super) {
  ...
  ElementSundayReview.prototype.html = function(position) {
    if (position === this.top || position === this.bottom) {
      return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/?hp" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/sundayReviewHpC375.png" /></a></h4>';
    } else if (position === this.left || position === this.right) {
      if (this.isCentered) {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/index.html?hp#sundayreview" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/sundayReviewHpC177.png" border="0" /></a></h4>';
      } else {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/index.html?hp#sundayreview" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/sundayReviewHpL177.png" border="0" /></a></h4>';
      }
    } else {
      return "";
    }
...
ElementTheOpinionPages = (function(_super) {
  ...
  ElementTheOpinionPages.prototype.html = function(position) {
    if (position === this.top || position === this.bottom) {
      return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/?hp" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/opinionPagesHpC375.png" /></a></h4>';
    } else if (position === this.left || position === this.right) {
      if (this.isCentered) {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/?hp" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/opinionPagesHpC177.png" border="0" /></a></h4>';
      } else {
        return '<h4 class="sectionHeaderHome"><a href="http://www.nytimes.com/pages/opinion/?hp" ><img src="http://graphics8.nytimes.com/packages/images/nytdesign/2014/opinion/homepage/opinionPagesHpL177.png" border="0" /></a></h4>';
      }
    } else {
      return "";
    }
