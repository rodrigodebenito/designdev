...
<html>
<head>
  <title>[Test 1] NYTimes.com Marketing Module Generator</title>
...
<body>
  ...
  <div id="page">
    <div id="header">
      <h1><a href="index.php">[Test 1] NYTimes.com Marketing Module Generator</a></h1>
    ...
    <div id="main">
        ...
        <form action="generated_page.php" method="post" accept-charset="utf-8">
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="mm[logurl]"></td>
            </tr><tr>
            <td style="border:0;"><label>Vertical GIF</label></td>
            <td style="border:0;" colspan="2"><input type="text"  name="mm[gifurl]"></td>  
            </tr><tr>
            <td style="border:0;"><label>Vertical URL</label></td>
            <td style="border:0;" colspan="2"><input type="text"  name="mm[txturl]"></td>
          </tr>
          
          <tr>
            <td><label>Photo</label></td>
            <td colspan="2"><input type="text" name="mm[photourl]"></td>
          </tr>          
          <tr>
            <td><label>Headline</label></td>
            <td><input type="text" name="mm[headurl]"></td>
            <td><input type="text" value="Text" name="mm[head]"></td>
          </tr>
          <tr>
            <td><label>Link 1</label></td>
            <td><input type="text" name="mm[l1url]"></td>
            <td><input type="text" value="Text" name="mm[l1]"></td>
          </tr>      
          <tr>
            <td><label>Link 2</label></td>
            <td><input type="text" name="mm[l2url]"></td>
            <td><input type="text" value="Text" name="mm[l2]"></td>
          </tr>      
          <tr>
            <td><label>Link 3</label></td>
            <td><input type="text" name="mm[l3url]"></td>
