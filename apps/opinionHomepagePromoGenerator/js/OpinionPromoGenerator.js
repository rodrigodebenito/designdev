...
LayoutManager = (function(_super) {
 ...
 LayoutManager.prototype.style = function(html) {
    return style_html(html, {
        ...
        }).replace(/<\/a>\s*<span\s+class="product-label\s+theme-nyt-now">\s*<span class="visually-hidden">NYT Now<\/span><i class="icon dot-logo-icon hidden"><\/i>\s*<\/span>/g, '</a><span class="product-label theme-nyt-now hidden"><span class="visually-hidden">NYT Now</span><i class="icon dot-logo-icon"></i></span>');
  };
...
StoriesManager = (function(_super) {
  ...
  function StoriesManager(data) {
    ...
    $(".managerRefresh").on("click", function(event) {
...
Template = (function() {
  ...
  Template.prototype.values = ["kicker", "contentKicker", "headline", "byline", "summary", "isBlog"];

  Template.prototype.hiddenValues =
  ...
  Template.prototype.htmlStory = function() {
    ...
    if (this.headline.test()) {
      html += "<h2 class=\"story-heading\"><a href=\"" + this.url + "\" >" + this.headline.value + "</a><span class=\"product-label theme-nyt-now\"><span class=\"visually-hidden\">NYT Now</span><i class=\"icon dot-logo-icon hidden\"></i></span></h2>";
    }
  ...
  Template.prototype.htmlHeadlineOnly = function() {
    var html;
    if (this.kicker.value === "Op-Docs") {
    return html = "<li><article class=\"story\"><h2 class=\"story-heading\"><a href=\"" + this.url + "\"><span class=\"icon video\">Op-Docs</span>: " + this.headline.value + "</a><span class=\"product-label theme-nyt-now\"><span class=\"visually-hidden\">NYT Now</span><i class=\"icon dot-logo-icon hidden\"></i></span></h2></article></li>";  
    } else {
    return html = "<li><article class=\"story\"><h2 class=\"story-heading\"><a href=\"" + this.url + "\">" + this.headline.value + "</a><span class=\"product-label theme-nyt-now\"><span class=\"visually-hidden\">NYT Now</span><i class=\"icon dot-logo-icon hidden\"></i></span></h2></article></li>";
    }
  };
  ...
  Template.prototype.generateEdit = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      value = _ref[_i];
      if (value != "contentKicker" && value != "isBlog") {
  ...
  Template.prototype.setHeadlineOnly = function(bool) {
    var i, thumb, value, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, kick, kick2, hed, byline, assetType;
    _ref = this.values;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      value = _ref[_i];
      if (value === "headline") {
    ...
    kick = this.kicker.getValue();
    kick2 = this.contentKicker.getValue(); 
    hed = this.headline.getValue();
    byline = this.byline.getValue();
    assetType = this.isBlog.getValue(); 
    if (kick === "Op-Ed Contributor" || kick === "Op-Ed Contributors") { 
        this.headline.setValue("Op-Ed: " + hed);
      } else if (kick === "Op-Ed Columnist" || kick2 === "Contributing Op-Ed Writer") {
        var lastName, pieces;
        pieces = byline.split(" ");
        lastName = pieces[pieces.length - 1];
        lastName = lastName.toLowerCase();
        lastName = lastName.capitalize();
        this.headline.setValue(lastName + ": " + hed);
      } else if (kick === "Editorial" || kick === "Today’s Editorials") {
        this.headline.setValue("Editorial: " + hed);
      } else if (assetType != "Article") {
        this.headline.setValue(kick + ": " + hed);
      } else if (kick === "Letter" || kick === "Letters") {
        this.headline.setValue(kick + ": " + hed);
      }
...
TemplateScoop = (function(_super) {
  ...
  function TemplateScoop(data) {
    ...
    this.contentKicker.setValue(this.data.cms.article.content_kicker);
    this.isBlog.setValue(this.data.cms.article.type);
    ...
    if (this.kicker.value === "Editorial" || this.kicker.value === "Today’s Editorials") {
      this.kicker.setDisplay(false);
    }
  }
...
TemplateWordpress = (function(_super) {
  ...
  function TemplateWordpress(data) {
    ...
    this.isBlog.setValue(this.data.blogpost.blog_name);
...
ValueRefer = (function(_super) {
  ...
  ValueRefer.prototype.getValue = function() {
    var label;
    if (this.icon === "") {
      return "<article class=\"story\"><h2 class=\"story-heading\"><a href=\"" + this.href + "\">" + this.text + "</a><span class=\"product-label theme-nyt-now\"><span class=\"visually-hidden\">NYT Now</span><i class=\"icon dot-logo-icon hidden\"></i></span></h2></article></li>";
