 ...
 * @version $Id: mm.php 234 2011-02-24 19:13:32Z jon $
 */
		...
		function getVertical($cvertical,$format="text") {
			  switch($cvertical) {
					...
					case "business":
						...
						break;
					case "dealbook":
						if($format == "two") { return "DB"; } else { return "DealBook"; }
						break;
					case "dining":
						if($format == "two") { return "DW"; } else { return "Dining & Wine"; }
						break;
					case "fashion":
						if($format == "two") { return "FA"; } else { return "Fashion"; }
						break;
					case "general":
					...
					case "mobile":
						...
						break;
					case "olympics":
						if($format == "two") { return "OL"; } else { return "Olympics"; }
						break;
					case "opinion":
					...
					case "realestate":
						...
						break;
					case "social":
						if($format == "two") { return "SO"; } else { return "Social"; }
						break;
					case "sports":
