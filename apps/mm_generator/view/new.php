...
<head>
 ...
 <?php 
   ...
   * @version $Id: new.php 234 2011-02-24 19:13:32Z jon $
   */
 ?>
  ...
  <style type="text/css">
  @import url(/apps/mm_generator/scripts/mooRainbow.css);
  </style>
<script src="/apps/mm_generator/scripts/mootools.js" type="text/javascript"></script>
<script src="/apps/mm_generator/scripts/mooRainbow.js" type="text/javascript"></script>
        ...
        <form action="generated_page.php" method="post" accept-charset="utf-8">
          <table> <? /* ?>
            ...
            <td colspan="2">
				...
				<OPTION VALUE="dealbook">DealBook
				<OPTION VALUE="dining">Dining &amp; Wine
				...
				<OPTION VALUE="olympics">Olympics
...
<input type="text" value="#004276" name="mm[headcolor]" id="myInput" style="width:100px;" size="5"> <img id="myRainbow" src="scripts/images/rainbow.png" alt="[r]" width="16" height="16" /> </td>
            <td> </td>
          </tr>
          </table>  
